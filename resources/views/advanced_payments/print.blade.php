...
padding: 13px;">
    ...
    <div style="width: 50%;float: left; font-size: 12px">
            ...
            <p>     الاسم  :   {{ $AdvancedPayment->patient->patientUser->full_name }} 
   <br> 
                 الهاتف :   {{ $AdvancedPayment->patient->patientUser->phone }}  
                    <br>  
   ...
   <br> 
                        ...
                        التاريخ:    {{ \Carbon\Carbon::parse($AdvancedPayment->date)->translatedFormat('jS M, Y')}}
                        <br>
                           {{ $AdvancedPayment->id }}    :     رقم  الفاتوره     <br> 
        ...
        <table>
            ...
            <tbody>
                  ...
                  <tr style="background-color:#ddd;">
                    ...
                    <td style="padding: 5px;width:40%;  border: 1px solid black !important;">  {{ getCurrencySymbol().' '.number_format($AdvancedPayment->amount) }} جنية</td>
