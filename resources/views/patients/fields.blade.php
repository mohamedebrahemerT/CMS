...
<div class="row gx-10 mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('last_name', __('messages.user.ID').':', ['class' => 'form-label']) }}
            <span class="required"></span>
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::email('email', null, ['class' => 'form-control',  'tabindex' => '3']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('dob', __('messages.user.dob').':', ['class' => 'form-label']) }}
            {{ Form::text('dob', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light patientBirthDate form-control' : 'bg-white   form-control')]) }}
        </div>
    </div>
      ...
      <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::text('phone', null, ['class' => 'form-control', 'required', 'id' => 'phone','tabindex' => '1']) }}
        </div>
    </div>
